...
一般一个新的交换机从草稿到商业化需要两年时间，如果仅仅是升级的话仅需要九个月，新产品的软件开发需要6个月到1年 [152]，早期投资高、风险大。作为设计中的中心部件，南向 API 是新技术在被引入和接受过程中的一个主要瓶颈。由此，以 OpenFlow 为例的SDN 南向 API 方案的出现得到了工业界的欢迎。
